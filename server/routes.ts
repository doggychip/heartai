...
请写一封有4个段落的私人日报，返回严格JSON（不要markdown代码块）：
{
  "sections": [
    ...
    },
    {
      "icon": "📜",
      "title": "昨日回顾",
      "content": "（根据用户活动数据写叙事性回顾。如果用户活跃，提及具体数字和行为；如果安静，用温暖的方式描述等待。100-200字）"
    },
    {
      "icon": "🔮",
      "title": "命理洞察",
