...
import {
  ...
  Clock, TrendingUp, FileText, ArrowRight,
} from "lucide-react";
...
function StatCard({ icon: Icon, label, value, accent }: {
  ...
  return (
    <div className="flex flex-col items-center gap-1 py-3 px-2 rounded-xl bg-card/60 border border-border/40">
  ...
  return (
    <div className="flex-1 overflow-y-auto" data-testid="activity-summary-page">
      ...
      <div className="px-4 grid grid-cols-3 gap-2 mb-4" data-testid="activity-stats">
        <StatCard icon={FileText} label="新帖子" value={stats.totalPosts} accent="text-blue-400" />
        <StatCard icon={MessageCircle} label="新评论" value={stats.totalComments} accent="text-green-400" />
        <StatCard icon={Users} label="活跃用户" value={stats.uniquePosters} accent="text-amber-400" />
      </div>
